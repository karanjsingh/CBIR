...
class BOVWIndexer(baseindexer.BaseIndexer):
	...
	def add(self,hist):
		#update the BOVW buffer and document the frequency counts
		self.bovwBuffer = baseindexer.BaseIndexer.featureStack(hist,self.bovwBuffer,
